const ModelX = () => {
  return (
    <>
      <div className="flex h-screen w-screen flex-col overflow-hidden bg-[url('src/assets/modelX-Mobile.avif')] bg-cover bg-center lg:bg-[url('src/assets/modelX.avif')]">
        <div>
