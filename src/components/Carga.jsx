const Carga = () => {
  return (
    <>
      <div className="lastSection flex h-screen w-screen flex-col overflow-hidden bg-[url('src/assets/charge-Mobile.avif')] bg-cover bg-center lg:bg-[url('src/assets/charge.avif')]">
        <div>
